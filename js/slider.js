$.fn.slider = function (options) {
  ...
  var $selector = this;
  var $blackColumn = $(".sliderContainer .blackColumn");
  var $imageColumn = $(".sliderContainer .imageColumn");
  var $slidesRow = $(".sliderContainer .imaColumn");
  var $arrowRight = $(".sliderContainer .arrows.right");
  var activeSlideCounter = 0;
  var offset = 0;
  var windowWidth = $(".sliderContainer").width();
  var slides = $(".sliderContainer .slides_row .slide").length;
  ...
  function slidesCopyingAtTheBeginning(
    ...
    for (var i = 0; i < slides; i++) {
      sliderItem
        ...
        .clone()
        .prependTo($(".slides_row"));
    }
    $slidesRow.css(
      "width",
      windowWidth * $(".sliderContainer .slides_row .slide").length +
        100 +
        "px"
    );
    setTimeout(function () {
  ...
  function navigationController(slideCount) {
    ...
    $('.pointers[data_nav="' + ((slideCount % slides) + 1) + '"]').addClass(
      "active"
    );
  }
  ...
  $(".sliderContainer .navigation .pointers").click(function () {
